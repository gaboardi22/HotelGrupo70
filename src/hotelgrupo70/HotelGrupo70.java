...
public class HotelGrupo70 {

    public static void main(String[] args) {
        // inserta un huesped
        //Huesped huesped1 = new Huesped("pablo", "gaboardi", 31222333, "barrio solares", "pablo@gmail.com", 11223344);
        //HuespedData huesped = new HuespedData();
        //huesped.insertarHuesped(huesped1);
        
        // actualiza un huesped
        //Huesped huesped1 = new Huesped( 2, "pablo2", "gaboardi2", 11222333, "barrio solares", "pablo@gmail.com", 11223344);
       // HuespedData huesped = new HuespedData();
        //huesped.actualizarHuesped(huesped1);
        
        //elimina un huesped
        //HuespedData huesped = new HuespedData();
        //huesped.eliminarHuesped(2);
        
        //listar huspedes
       
        //HuespedData huespedData = new HuespedData();
        //List<Huesped> huespedes = new ArrayList<>();
        //huespedes = huespedData.consultaHuesped();
